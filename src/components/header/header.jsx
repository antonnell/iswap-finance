      ...
      <div className={ classes.root }>
        <div className={ classes.header }>
          ...
          <div className={ classes.linksContainer }>
            <div className={ `${classes.link} ${classes.link_active}` }><Typography variant={ 'body1' }>iswap</Typography></div>
            <div className={ classes.link }><Typography variant={ 'body1' }>iearn</Typography></div>
